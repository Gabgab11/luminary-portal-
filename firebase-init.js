// ============================================================
// Firebase connection — shared by login.html, admin.html, and the
// client portal.
...
//
// firebaseConfig is exported (not just used internally) so admin.js
// can spin up a *second* Firebase app instance when creating a new
// client's login — that keeps your own admin session signed in while
// their account gets created in the background.
// ============================================================
